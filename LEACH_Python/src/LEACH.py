...
# type(obj.sum_energy_left_all_nodes)
# l=[i for i in range(1,obj.r+2)]
# #type(np.array(200))
# #plt.plot(l,obj.sum_energy_left_all_nodes[:obj.r+1])
# #plt.savefig("fig1.png")
#plt1=plt.figure()
 

# plt1.xlim(left=0, right=obj.my_model.rmax)
# plt1.ylim(bottom=0, top=obj.n)
# plt1.plot(obj.alive_sensors)
# plt1.title("Life time of sensor nodes")
# plt1.xlabel('Rounds')
# plt1.ylabel('No. of live nodes')
# # plt.ioff()
# #plt.show()
# plt1.savefig("Life time of sensor nodes.png")
# plt1.clf()

# import matplotlib.pyplot as plt2
# #plt2=plt.figure()
# plt2.xlim(left=0, right=obj.my_model.rmax)
# plt2.ylim(bottom=0, top=obj.n * obj.my_model.Eo)
# plt2.plot(obj.sum_energy_left_all_nodes)
# plt2.title("Total residual energy ")
# plt2.xlabel('Rounds')
# plt2.ylabel('Energy (J)')
# plt2.savefig("Total residual energy.png")
